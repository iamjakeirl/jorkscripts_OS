# JorkHunter – Box Trapper User Guide

## What This Script Does
- Hunts chinchompas using **box traps**.
- Places traps in a selected pattern around a tile you choose in-game.
- Checks, resets, and replaces traps automatically.
...
- `Black Chinchompa`
- `Embertailed Jerboa`
- **Ferrets** require special settings: you must enable 'minimenu reodering' in the settings menu, and then reorder the options on Ferrets in your inventory to show "Release" as the first option. 

## Requirements
- Box traps in inventory (I reccomend a large amount, 1000+ at least)
...
## Inventory Handling
- **IMPORTANT:** if you want to hunt ferrets, you have to menu entry swap "Release" as the single tap option. 
- The script **keeps chinchompas and jerboas**.
- It **drops ferrets** when your inventory is low on space. 
